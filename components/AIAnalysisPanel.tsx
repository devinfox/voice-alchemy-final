...
export default function AIAnalysisPanel({ isOpen, onClose, onAnalysisComplete }: AIAnalysisPanelProps) {
  ...
  return (
    <>
      ...
      {/* Slide-out Panel */}
      <div className="fixed top-0 right-0 h-full w-full max-w-md modal-solid border-l border-slate-700/50 shadow-2xl z-50 animate-slide-in-right overflow-hidden flex flex-col">
        {/* Header */}
